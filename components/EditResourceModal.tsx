        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            ...
            >
                ...
                <div className="flex items-center justify-between px-7 py-5 border-b border-slate-100 dark:border-slate-800">
                    <div>
                        <h2 className="text-xl font-bold text-[#1E3A8A] dark:text-brand-primary">Edit Resource</h2>
                        <p className="text-xs text-slate-400 dark:text-foreground/40 mt-0.5">Update the details for <span className="font-semibold text-slate-500 dark:text-foreground/60">{resource.name}</span></p>
                    </div>
                    <button
                        onClick={onClose}
