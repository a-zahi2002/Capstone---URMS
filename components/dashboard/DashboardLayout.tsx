    ...
    return (
        <div className="flex h-screen bg-background overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                {/* ── Top bar ── */}
                <header className="sticky top-0 z-20 h-16 bg-white/70 dark:bg-[#0B111E]/70 backdrop-blur-md border-b border-border flex items-center justify-between px-4 lg:px-6 shrink-0 shadow-sm">
                    {/* Left: mobile menu + breadcrumb */}
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => setMobileOpen(true)}
                            className="lg:hidden p-2 rounded-full hover:bg-slate-100 dark:hover:bg-white/5 transition-colors cursor-pointer"
                                        ...
                                        <span
                                            className={
                                                isLast
                                                    ...
                                                    : "text-slate-450 dark:text-foreground/45 font-medium"
                                            }
                                        >
                                            {formatted}
                                        </span>
