            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="relative overflow-hidden rounded-none bg-card border border-slate-200 dark:border-border p-8 border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)]">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-primary/10 rounded-none text-sm font-semibold text-brand-primary mb-4 border border-brand-primary/20">
                                <Activity className="w-4 h-4" /> Reporting Engine
                            </div>
                            <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-2">
                                Activity <span className="text-transparent bg-clip-text bg-card  ">Reports</span>
                            </h1>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="bg-brand-primary hover:opacity-90 disabled:opacity-50 px-6 py-3 rounded-none text-white font-bold transition-all border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] flex items-center gap-2"
                            >
                            ...
                            <button
                                ...
                                disabled={exporting !== null || tickets.length === 0}
                                className="bg-emerald-500 hover:opacity-90 disabled:opacity-50 px-6 py-3 rounded-none text-white font-bold transition-all border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] flex items-center gap-2"
                            >
                ...
                {/* Filters */}
                <div className="bg-card border border-slate-200 dark:border-border rounded-none p-6 border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-grow mr-0 md:mr-8">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 bg-slate-100 dark:bg-foreground/5 border border-slate-200 dark:border-border rounded-none text-sm font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                            >
                    ...
                    <button
                        ...
                        title="Reload Data"
                        className="p-3 bg-slate-100 dark:bg-foreground/5 border border-slate-200 dark:border-border rounded-none hover:bg-slate-200 transition-colors self-end md:self-auto"
                    >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={idx} className="bg-card rounded-none p-6 border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] border border-slate-200 dark:border-border flex items-center justify-between">
                            <div>
                            ...
                            <div className={`p-3 rounded-none bg-${m.color}-500/10 text-${m.color}-500`}>
                ...
                <div className="bg-card rounded-none border-2 border-foreground shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] border border-slate-200 dark:border-border overflow-hidden">
                    <div className="p-6 md:p-8 border-b border-slate-200 dark:border-border flex items-center justify-between">
                        ...
                        <span className="text-xs font-black text-slate-400 dark:text-foreground/35 uppercase tracking-wider bg-slate-100 dark:bg-foreground/5 px-3.5 py-1.5 rounded-none border border-slate-200 dark:border-border">
                                    ...
                                    <tr>
                                        <td colSpan={6} className="px-6 py-16 text-center">
                                            <div className="inline-flex flex-col items-center gap-3">
                                                <div className="w-14 h-14 rounded-none bg-slate-100 dark:bg-foreground/5 flex items-center justify-center"><FileText className="w-7 h-7 text-slate-400" /></div>
                                    ...
                                    tickets.map(ticket => {
                                        ...
                                        return (
                                            <tr key={ticket.id} className="hover:bg-foreground/[0.01] transition-colors">
                                                ...
                                                <td className="px-6 py-5">
                                                    <span className={`inline-flex items-center px-2.5 py-1 rounded-none text-xs font-bold border ${statusBadge}`}>
